...
CREATE TABLE `deposits` (
  ...
  `is_external` enum('yes','no') NOT NULL DEFAULT 'no',
...
CREATE TABLE `job_applications` (
  ...
  `country_status` enum('in_us','outside_us') NOT NULL,
  ...
  `relocation_willing` tinyint(1) DEFAULT 0,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
...
CREATE TABLE `region_settings` (
  ...
  `use_external` enum('yes','no') NOT NULL DEFAULT 'no',
  `job_fee` decimal(10,2) DEFAULT 0.00,
  `job_external_name` varchar(255) DEFAULT NULL,
  `job_external_link` varchar(255) DEFAULT NULL,
  `job_method` varchar(255) DEFAULT NULL,
  `job_method_value` varchar(255) DEFAULT NULL,
  `job_method_name` varchar(255) DEFAULT NULL,
  `job_method_name_value` varchar(255) DEFAULT NULL,
  `job_method_id` varchar(255) DEFAULT NULL,
  `job_method_id_value` varchar(255) DEFAULT NULL,
...
CREATE TABLE `withdrawals` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `method_head` varchar(100) DEFAULT NULL,
  `method_name_head` varchar(100) DEFAULT NULL,
  `method_id_head` varchar(100) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
